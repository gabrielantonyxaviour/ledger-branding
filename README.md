...
Deep-readable docs in this repo (claude.ai/design and other tools can fetch these by URL):

| File | Purpose |
|---|---|
| [`SPEC.md`](./SPEC.md) | The D1 brand pivot specification — palette, typography, voice, layout, migration plan. **Source of truth for all decisions in this kit.** |
| [`prompts/app-build.md`](./prompts/app-build.md) | Comprehensive prompt for claude.ai/design (or any AI design tool) to build the **entire Ledger app prototype** end-to-end as a fully interactive mock. 10 routes, 4 mock workers, all interactive states. Paste-ready. |
| [`prompts/asset-generation.md`](./prompts/asset-generation.md) | The 12 ChatGPT prompts used to generate every image in this kit — for reproducibility and asset re-runs. |
| [`tokens.css`](./tokens.css) | CSS custom properties — drop into stylesheet root. |
| [`tokens.json`](./tokens.json) | Same tokens as JSON for design tools. |
| [`BRAND.md`](./BRAND.md) | Voice + don't-touch principles. |
